...
namespace EfiritPro.Retail.ProductModule.Persistence.Migrations
{
    ...
    [Migration("20240814093622_setTree")]
    partial class setTree
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("EfiritPro.Retail.ProductModule.Models.Product", b =>
                {
                    ...
                    b.Property<Guid?>("ParentProductOrganizationId")
                        .HasColumnType("uuid")
                        .HasColumnName("parent_product_organization_id");

                    b.Property<Guid?>("ParentProductOwnerId")
                        .HasColumnType("uuid")
                        .HasColumnName("parent_product_owner_id");
                    ...
                    b.HasIndex("ParentProductId", "ParentProductOwnerId", "ParentProductOrganizationId")
                        .HasDatabaseName("ix_products_parent_product_id_parent_product_owner_id_parent_p");
            ...
            modelBuilder.Entity("EfiritPro.Retail.ProductModule.Models.Product", b =>
                {
                    ...
                    b.HasOne("EfiritPro.Retail.ProductModule.Models.Product", "ParentProduct")
                        .WithMany()
                        .HasForeignKey("ParentProductId", "ParentProductOwnerId", "ParentProductOrganizationId")
                        .HasConstraintName("fk_products_products_parent_product_id_parent_product_owner_id");

...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EfiritPro.Retail.Packages.RabbitModule.Models.RabbitEvent", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("EfiritPro.Retail.ProductModule.Models.Product", b =>
                {
                    ...
                    b.Property<Guid?>("CurrentProductPriceId")
                        .HasColumnType("uuid")
                        .HasColumnName("current_product_price_id");
                    ...
                    b.HasIndex("CurrentProductPriceId", "OwnerId", "OrganizationId", "Id")
                        .HasDatabaseName("ix_products_current_product_price_id_owner_id_organization_id_");
            ...
            modelBuilder.Entity("EfiritPro.Retail.ProductModule.Models.Product", b =>
                {
                    ...
                    b.HasOne("EfiritPro.Retail.ProductModule.Models.ProductPrice", "CurrentProductPrice")
                        .WithMany()
                        .HasForeignKey("CurrentProductPriceId", "OwnerId", "OrganizationId", "Id")
                        .OnDelete(DeleteBehavior.SetNull)
                        .HasConstraintName("fk_products_product_prices_current_product_price_id1");

                    b.Navigation("CurrentProductPrice");

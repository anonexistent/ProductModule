...
namespace EfiritPro.Retail.ProductModule.Persistence.Migrations
{
    ...
    [Migration("20240812065709_productSetTable")]
    partial class productSetTable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("EfiritPro.Retail.ProductModule.Models.ProductSet", b =>
                {
                    ...
                    //  оно создается автоматически, но не планировалось
                    //b.Property<Guid?>("ProductOrganizationId")
                    //    .HasColumnType("uuid")
                    //    .HasColumnName("product_organization_id");

                    //b.Property<Guid?>("ProductOwnerId")
                    //    .HasColumnType("uuid")
                    //    .HasColumnName("product_owner_id");
